...
// [rayplot] disabled: #define SUPPORT_SCREEN_CAPTURE 1
// Allow automatic gif recording of current screen pressing CTRL+F12, defined in KeyCallback()
// [rayplot] disabled: #define SUPPORT_GIF_RECORDING 1
// Support CompressData() and DecompressData() functions
#define SUPPORT_COMPRESSION_API         1
// Support automatic generated events, loading and recording of those events when required
// [rayplot] disabled: #define SUPPORT_AUTOMATION_EVENTS 1
...
// [rayplot] disabled: #define SUPPORT_FILEFORMAT_GIF 1
// [rayplot] disabled: #define SUPPORT_FILEFORMAT_QOI 1
//#define SUPPORT_FILEFORMAT_PSD      1
// [rayplot] disabled: #define SUPPORT_FILEFORMAT_DDS 1
...
// [rayplot] disabled: #define SUPPORT_IMAGE_EXPORT 1
...
// [rayplot] disabled: #define SUPPORT_FILEFORMAT_FNT 1
...
// [rayplot] disabled: #define SUPPORT_FILEFORMAT_OBJ 1
// [rayplot] disabled: #define SUPPORT_FILEFORMAT_MTL 1
// [rayplot] disabled: #define SUPPORT_FILEFORMAT_IQM 1
// [rayplot] disabled: #define SUPPORT_FILEFORMAT_GLTF 1
// [rayplot] disabled: #define SUPPORT_FILEFORMAT_VOX 1
// [rayplot] disabled: #define SUPPORT_FILEFORMAT_M3D 1
// Support procedural mesh generation functions, uses external par_shapes.h library
// NOTE: Some generated meshes DO NOT include generated texture coordinates
// [rayplot] disabled: #define SUPPORT_MESH_GENERATION 1
...
// [rayplot] disabled: #define SUPPORT_TRACELOG 1
